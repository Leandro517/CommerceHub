...
<body>
    ...
    <main>
        ...
        <section class="card">
            ...
            <a href="cadastro_produtos.php"><button>Cadastrar Categoria</button></a>
        </section>
        ...
        <!-- Cadastro de Categoria-->
         <section class="card">
            ...
            <a href="cadastro_categorias.php"><button>Cadastrar Produto</button></a>
        </section>
    ...
    <footer>
        <p>© 2024 CommerceHub - Todos os direitos reservados.</p>
    </footer>
</body>
</html>