...
// Processar o cadastro ou edição da categoria se o método for POST
...
// Processar a exclusão da categoria se o método for DELETE
...
<body>
    ...
    <div class="container">
        <section class="search-section">
            ...
            <button class="add-category-button" onclick="openModal()">+ Cadastrar Categoria</button>
        </section>
